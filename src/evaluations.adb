...
begin
   ...
   -------------------------------
   Put_Line
     ("********* Sudoku tres tres facile : grille1TresTresFacileDuNouvelAn2018");
   ...
   -------------------------------
   Put_Line
     ("********* Sudoku tres tres facile : grille2TresTresFacile");
   ...
   -------------------------------
   Put_Line ("********* Sudoku tres facile : grille3TresFacile");
   g := grille3TresFacile;
   ...
   -------------------------------
   Put_Line ("********* Sudoku tres difficile : grille9TresDifficile");
