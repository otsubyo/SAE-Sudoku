...
with cas_possibles; use cas_possibles;
with Pile_caspossible; use Pile_caspossible;
...
package resolutions is
   ...
   -- et FAUX sinon
   -- necessite la case c est vide
   -- leve l'exception CASE_NON_VIDE si la case n'est pas vide
   ...
   -- necessite qu'il n'y ait qu'un seul chiffre dans resultats
   -- leve l'exception PLUS_DE_UN_CHIFFRE s'il y a plus d'un chiffre dans resultats
